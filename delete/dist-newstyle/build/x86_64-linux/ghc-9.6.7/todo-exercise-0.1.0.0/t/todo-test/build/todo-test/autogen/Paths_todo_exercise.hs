...
-- at runtime using the environment variable todo_exercise_bindir.
...
-- environment variable todo_exercise_libdir.
...
-- using the environment variable todo_exercise_dynlibdir.
...
-- runtime using the environment variable todo_exercise_datadir.
...
-- variable todo_exercise_libexedir.
...
-- using the environment variable todo_exercise_sysconfdir.
...
libdir     = "/home/progressio/.cabal/lib/x86_64-linux-ghc-9.6.7/todo-exercise-0.1.0.0-inplace-todo-test"
dynlibdir  = "/home/progressio/.cabal/lib/x86_64-linux-ghc-9.6.7"
datadir    = "/home/progressio/.cabal/share/x86_64-linux-ghc-9.6.7/todo-exercise-0.1.0.0"
libexecdir = "/home/progressio/.cabal/libexec/x86_64-linux-ghc-9.6.7/todo-exercise-0.1.0.0"
sysconfdir = "/home/progressio/.cabal/etc"

getBinDir     = catchIO (getEnv "todo_exercise_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "todo_exercise_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "todo_exercise_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "todo_exercise_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "todo_exercise_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "todo_exercise_sysconfdir") (\_ -> return sysconfdir)
